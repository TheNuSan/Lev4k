...
static DEVMODE screenSettings = { 
	...
	#include "shaudio.h"
	static_assert(SHAUDIO_XRES * SHAUDIO_YRES >= MAX_SAMPLES, "SHAUDIO: render resolution must be larger than MAX_SAMPLES");
	static SAMPLE_TYPE lpSoundBuffer[SHAUDIO_XRES * SHAUDIO_YRES * 2];
#else
